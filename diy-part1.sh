...
sed -i '$a src-git serverchan/luci-app-serverchan https://github.com/tty228/luci-app-serverchan.git;master' feeds.conf.default
...
sed -i '$a src-git adguardhome/luci-app-adguardhome https://github.com/kongfl888/luci-app-adguardhome.git;master' feeds.conf.default
